...
import type { SubscriptionRowAccountProps } from './types';
...
export const SubscriptionRowAccount = ({
  ...
  useEffect(() => {
    if (!enabled && osNotify) {
      toggleOsNotifyForAccount(subscription, false);
    }
  }, [enabled]);
        ...
        <div style={{ flex: 0 }}>
          <FlexRow $gap="1.75rem">
            ...
            <button
              ...
              onClick={() => toggleOsNotifyForAccount(subscription)}
            >
            ...
            <span style={{ scale: '0.9' }}>
              <Switch
                ...
                isOn={enabled}
                handleToggle={async () => {
                  await toggleForAccount(subscription);
                }}
              />
            </span>
          </FlexRow>
